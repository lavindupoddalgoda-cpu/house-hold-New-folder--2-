...
import { SEED_CATEGORIES, STORE } from '@/types';
    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">Fill in the details below to create a product</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    id="tags"
                    placeholder="kitchen, cooking, electric"
                    value={form.tags}
            ...
            <CardContent className="space-y-4">
              {variants.length === 0 && (
                <p className="text-sm text-slate-500 text-center py-4">
                  No variants added. Click &quot;Add Group&quot; to create variant options.
                </p>
              )}
          ...
          <Card className="rounded-2xl shadow">
            ...
            <CardContent className="space-y-3">
              ...
              <p className="text-xs text-slate-400">
                Enter image URLs for demo purposes. In production, images would be uploaded to storage.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-baseline gap-2">
                  {discountPrice > 0 ? (
                    ...
                    <span className="text-lg font-bold text-slate-900">
                      {sellingPrice > 0 ? formatCurrency(sellingPrice) : STORE.symbol + ' 0.00'}
                    </span>
                  )}
                </div>
                {form.stock && (
                  <p className="text-xs text-slate-500">{form.stock} in stock</p>
                )}
              </div>
            </CardContent>
          </Card>
          ...
          <Button
            onClick={handleSave}
            disabled={saving}
            className="w-full bg-emerald-500 hover:bg-emerald-600 text-white gap-2 h-12"
          >
            {saving ? (
              <>
